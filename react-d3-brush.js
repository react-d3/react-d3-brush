...
/***/ function(module, exports, __webpack_require__) {
	...
	var _area_stack = __webpack_require__(149);

	var _area_stack2 = _interopRequireDefault(_area_stack);

	var _scatter = __webpack_require__(150);

	var _scatter2 = _interopRequireDefault(_scatter);

	var _bar = __webpack_require__(151);

	var _bar2 = _interopRequireDefault(_bar);

	var _bar_group = __webpack_require__(152);

	var _bar_group2 = _interopRequireDefault(_bar_group);

	var _bar_stack = __webpack_require__(153);

	var _bar_stack2 = _interopRequireDefault(_bar_stack);

	// inherit

	var _inheritIndex = __webpack_require__(145);

	var _inheritIndex2 = _interopRequireDefault(_inheritIndex);

	// utils

	var _utilsBrush = __webpack_require__(147);

	var _utilsBrush2 = _interopRequireDefault(_utilsBrush);

	var _utilsBrush_focus = __webpack_require__(148);

	var _utilsBrush_focus2 = _interopRequireDefault(_utilsBrush_focus);

	exports.LineBrush = _line2['default'];
	exports.AreaStackBrush = _area_stack2['default'];
	exports.ScatterBrush = _scatter2['default'];
	exports.BarBrush = _bar2['default'];
	exports.BarGroupBrush = _bar_group2['default'];
	exports.BarStackBrush = _bar_stack2['default'];
	exports.BrushSet = _inheritIndex2['default'];
	exports.Brush = _utilsBrush2['default'];
	exports.BrushFocus = _utilsBrush_focus2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LineBrush = (function (_BrushSet) {
	  _inherits(LineBrush, _BrushSet);

	  function LineBrush(props) {
	    _classCallCheck(this, LineBrush);

	    _get(Object.getPrototypeOf(LineBrush.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(LineBrush, [{
	    ...
	    value: function render() {
	      ...
	      var brush = _react2['default'].createElement(_utilsBrush2['default'], _extends({ xDomain: this.setXDomain, yDomain: this.setYDomain }, this.props, this.state, { brushType: 'line', chartSeriesData: chartSeriesData, setDomain: this.setDomain.bind(this) }));
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _reactD3Core.Chart,
	          this.props,
	          _react2['default'].createElement(_reactD3Basic.LineChart, _extends({}, this.props, this.state, { xDomain: xDomainSet, showBrush: true })),
	          focus
	        ),
	        brush
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _area_stack = __webpack_require__(140);

	var _area_stack2 = _interopRequireDefault(_area_stack);

	var _bar = __webpack_require__(141);

	var _bar2 = _interopRequireDefault(_bar);

	var _bar_group = __webpack_require__(142);

	var _bar_group2 = _interopRequireDefault(_bar_group);

	var _bar_stack = __webpack_require__(143);

	var _bar_stack2 = _interopRequireDefault(_bar_stack);

	var _pie = __webpack_require__(144);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactFauxDom = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styleAttr = __webpack_require__(94)
	var camelCase = __webpack_require__(95)
	var assign = __webpack_require__(102)
	var mapValues = __webpack_require__(113)
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var arrayCopy = __webpack_require__(83),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var createCompounder = __webpack_require__(96);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var deburr = __webpack_require__(97),
	    words = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonProps = __webpack_require__(138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonProps = __webpack_require__(146);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BrushFocus = (function (_Component) {
	  _inherits(BrushFocus, _Component);

	  function BrushFocus(props) {
	    _classCallCheck(this, BrushFocus);

	    _get(Object.getPrototypeOf(BrushFocus.prototype), 'constructor', this).call(this, props);
	  }

	  _createClass(BrushFocus, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props;
	      var height = _props.height;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScatterBrush = (function (_BrushSet) {
	  _inherits(ScatterBrush, _BrushSet);

	  function ScatterBrush(props) {
	    _classCallCheck(this, ScatterBrush);

	    _get(Object.getPrototypeOf(ScatterBrush.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(ScatterBrush, [{
	    ...
	    value: function render() {
	      ...
	      var focus = _react2['default'].createElement(_utilsBrush_focus2['default'], this.props);
	      var brush = _react2['default'].createElement(_utilsBrush2['default'], _extends({ xDomain: this.setXDomain, yDomain: this.setYDomain }, this.props, this.state, { brushType: 'scatter', chartSeriesData: chartSeriesData, setDomain: this.setDomain.bind(this) }));
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _reactD3Core.Chart,
	          this.props,
	          _react2['default'].createElement(_reactD3Basic.ScatterPlot, _extends({}, this.props, { xDomain: xDomainSet, showBrush: true })),
	          focus
	        ),
	        brush
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarBrush = (function (_BrushSet) {
	  _inherits(BarBrush, _BrushSet);

	  function BarBrush(props) {
	    _classCallCheck(this, BarBrush);

	    _get(Object.getPrototypeOf(BarBrush.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(BarBrush, [{
	    ...
	    value: function render() {
	      ...
	      var focus = _react2['default'].createElement(_utilsBrush_focus2['default'], this.props);
	      var brush = _react2['default'].createElement(_utilsBrush2['default'], _extends({ xDomain: this.setXDomain, yDomain: this.setYDomain }, this.props, this.state, { brushType: 'bar', chartSeriesData: chartSeriesData, setDomain: this.setDomain.bind(this) }));
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _reactD3Core.Chart,
	          this.props,
	          _react2['default'].createElement(_reactD3Basic.BarChart, _extends({}, this.props, this.state, { xDomain: xDomainSet, showBrush: true })),
	          focus
	        ),
	        brush
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarGroupBrush = (function (_BrushSet) {
	  _inherits(BarGroupBrush, _BrushSet);

	  function BarGroupBrush(props) {
	    _classCallCheck(this, BarGroupBrush);

	    _get(Object.getPrototypeOf(BarGroupBrush.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(BarGroupBrush, [{
	    ...
	    value: function render() {
	      ...
	      var focus = _react2['default'].createElement(_utilsBrush_focus2['default'], this.props);
	      var brush = _react2['default'].createElement(_utilsBrush2['default'], _extends({ xDomain: this.setXDomain, yDomain: this.setYDomain }, this.props, this.state, { brushType: 'bar_group', chartSeriesData: chartSeriesData, setDomain: this.setDomain.bind(this) }));
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _reactD3Core.Chart,
	          this.props,
	          _react2['default'].createElement(_reactD3Basic.BarGroupChart, _extends({}, this.props, this.state, { xDomain: xDomainSet, showBrush: true })),
	          focus
	        ),
	        brush
	      );
	  ...
	  return BarGroupBrush;
	})(_inheritIndex2['default']);

	exports['default'] = BarGroupBrush;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarStackBrush = (function (_BrushSet) {
	  _inherits(BarStackBrush, _BrushSet);

	  function BarStackBrush(props) {
	    _classCallCheck(this, BarStackBrush);

	    _get(Object.getPrototypeOf(BarStackBrush.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(BarStackBrush, [{
	    ...
	    value: function render() {
	      ...
	      var focus = _react2['default'].createElement(_utilsBrush_focus2['default'], this.props);
	      var brush = _react2['default'].createElement(_utilsBrush2['default'], _extends({ xDomain: this.setXDomain, yDomain: this.setYDomain }, this.props, this.state, { brushType: 'bar_stack', chartSeriesData: chartSeriesData, setDomain: this.setDomain.bind(this) }));
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _reactD3Core.Chart,
	          this.props,
	          _react2['default'].createElement(_reactD3Basic.BarStackChart, _extends({}, this.props, this.state, { xDomain: xDomainSet, showBrush: true })),
	          focus
	        ),
	        brush
	      );
	  ...
	  return BarStackBrush;
	})(_inheritIndex2['default']);

	exports['default'] = BarStackBrush;
	module.exports = exports['default'];
