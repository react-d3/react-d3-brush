...
export default class BarStackBrush extends BrushSet {
  ...
  render() {
    ...
    var brush = <Brush xDomain= {this.setXDomain} yDomain= {this.setYDomain} {...this.props} {...this.state} brushType="bar_stack" chartSeriesData={chartSeriesData} setDomain={this.setDomain.bind(this)} />
