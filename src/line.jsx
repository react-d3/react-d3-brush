...
export default class LineBrush extends BrushSet {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    var brush = <Brush xDomain= {this.setXDomain} yDomain= {this.setYDomain} {...this.props} {...this.state} brushType="line" chartSeriesData={chartSeriesData} setDomain={this.setDomain.bind(this)} />
